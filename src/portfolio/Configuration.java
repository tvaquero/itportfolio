...
public void solve_problems(){
	//Structure: 2 cycles. The outer one will go through the available planners, and the inner one
	// will go through the training problems. It calls execplanners. For each planner a single XML will be generated. 
	// Such XML will be then analyzed by the function Analyze plans.
	// Maybe we should generate a planner class for saving the position of such XMLs.
	return;
}
